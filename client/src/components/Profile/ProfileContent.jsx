        ...
        <>
          <div className="flex justify-center w-full">
            <div className="relative">
              <img
                ...
                className="w-[150px] h-[150px] rounded-full object-cover border-4 border-orange-400 shadow"
                alt="profile"
              />
              <div className="w-[34px] h-[34px] bg-orange-100 rounded-full flex items-center justify-center cursor-pointer absolute bottom-[5px] right-[5px] border-2 border-orange-400">
                <input
                  type="file"
                  id="image"
                  className="hidden"
                ...
                <label htmlFor="image" className="cursor-pointer">
                  <AiOutlineCamera className="text-orange-500" />
                </label>
              </div>
            </div>
          </div>
          ...
          <div className="w-full px-5">
            <form onSubmit={handleSubmit}>
              ...
              <button
                className="w-[250px] h-[40px] bg-orange-500 text-white font-semibold rounded-lg mt-8 hover:bg-orange-600 transition"
                type="submit"
              >
                Update
              </button>
...
const ChangePassword = () => {
  ...
  return (
    <div className="w-full px-5">
      <h1 className="block text-[25px] text-center font-[600] text-gray-800 pb-2">
        Change Password
      </h1>
      <div className="w-full">
        <form
        ...
        >
          ...
          <div className="w-full 800px:w-[50%] mt-2">
            ...
            />
            <button
              className="w-full h-[40px] bg-orange-500 text-white font-semibold rounded-lg mt-8 hover:bg-orange-600 transition"
              type="submit"
            >
              Update
            </button>
    ...
    <div className="w-full px-5">
      {open && (
        <div className="fixed w-full h-screen bg-[#0000004b] top-0 left-0 flex items-center justify-center z-50">
          <div className="w-[95%] max-w-lg bg-white rounded-2xl shadow-lg relative overflow-y-scroll max-h-[90vh]">
            ...
            <h1 className="text-center text-[25px] font-semibold text-gray-800 mb-4">
              Add New Address
            </h1>
            <form onSubmit={handleSubmit} className="w-full px-6 pb-6">
              <div className="w-full pb-2">
                ...
                <select
                  ...
                  className="w-full border h-[40px] rounded-lg px-2"
                >
              ...
              <button
                type="submit"
                className="w-full h-[40px] bg-orange-500 text-white font-semibold rounded-lg mt-5 hover:bg-orange-600 transition"
              >
                Save Address
              </button>
            </form>
